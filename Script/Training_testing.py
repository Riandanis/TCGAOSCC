...
for i in range(0,10):
    train_csv_path ='/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/train/labels_train.csv'
    train_root_path ='/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/train'
    test_csv_path ='/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/test/labels_test.csv'
    test_root_path ='/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/test'
    test_label_path = '/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/test/test_label_run_th1.csv'
    predicted_label_path = '/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/test/predicted_label_run_th1.csv'
    model_path = '/home/DL-based-Tumor-Classification/Data_mapped_images/img_fold' + str(i) + '/network_0505_th1.pth'
